...
public class MidoNetElement extends AdapterBase implements
    ...
    @Override
    public boolean ConfigDhcp(Network network, NicProfile nic, VirtualMachineProfile<? extends VirtualMachine> vm, DeployDestination dest, ReservationContext context) throws ConcurrentOperationException, InsufficientCapacityException, ResourceUnavailableException {
