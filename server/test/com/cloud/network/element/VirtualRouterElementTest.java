...
public class VirtualRouterElementTest {
    ...
    @Test
    public void isUpdateCompleteTest1(){
        Network network=new NetworkVO(4l,null,null,null,1l,1l,1l,1l,"d","d","d",null,1l,1l,null,true,null,true);
        mockDAOs((NetworkVO)network,testOffering);
        assertTrue(virtualRouterElement.isUpdateComplete(network));
    }

    @Test
    public void isUpdateCompleteTest2(){
        Network network=new NetworkVO(5l,null,null,null,1l,1l,1l,1l,"d","d","d",null,1l,1l,null,true,null,true);
        mockDAOs((NetworkVO)network,testOffering);
        assertTrue(!virtualRouterElement.isUpdateComplete(network));
    }
    ...
    private void mockDAOs(final NetworkVO network, final NetworkOfferingVO offering) {
        ...
        List<DomainRouterVO> routerList4=new ArrayList<>();
        routerList4.add(routerNeedUpdateMaster);
        routerList4.add(routerUpdateComplete);
        List<DomainRouterVO> routerList5=new ArrayList<>();
        routerList5.add(routerUpdateComplete);
        routerList5.add(routerUpdateInProgress);
        ...
        when(_routerDao.listByNetworkAndRole(4l, VirtualRouter.Role.VIRTUAL_ROUTER)).thenReturn(routerList3);
        when(_routerDao.listByNetworkAndRole(5l, VirtualRouter.Role.VIRTUAL_ROUTER)).thenReturn(routerList4);
        when(_routerDao.listByNetworkAndRole(6l, VirtualRouter.Role.VIRTUAL_ROUTER)).thenReturn(routerList5);
